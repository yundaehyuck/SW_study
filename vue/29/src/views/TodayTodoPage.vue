<template>
    <div class="todolist">
        <h3 class="text-start ms-4 mt-3">오늘 할일</h3>
        <div class="work">
        ...
        <div class="checkbox row1 d-flex justify-content-between" v-if="todo.dueDateTime.substring(0,10) === compute_today && todo.isCompleted === false">
